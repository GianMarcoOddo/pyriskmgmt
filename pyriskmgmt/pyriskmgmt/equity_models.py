...
class EquityPrmPort:
    ...
    def garch_model(self, p: int = 1, q: int = 1, warning: bool = True):
        ...
        - warning: A flag that, if set to True, prints a warning message about prerequisites. Defaults is True.
        ...
        'rmgarch' package installed in your R environment.
        """
        ...
        from pyriskmgmt.inputsControlFunctions import (check_p, check_q, check_warning)

        # check procedure
        p = check_p(p) ; q = check_q(q) ; check_warning(warning)

        if warning:
            from pyriskmgmt.SupportFunctions import garch_warnings
            garch_warnings("garch_model()")
    ...
    def sharpeDiag(self, mappingRets: np.ndarray = None, vol: str = "simple", p: int = 1, q: int = 1,
        ...
        - warning: A flag indicating whether a warning message should be printed about the prerequisites. Default is True.
    ...
    def mcModelDrawPortRets(self, sharpeDiag: bool = False, mappingRets: np.ndarray = None, 
        ...
        if vol == "garch":
            ...
            if warning:
                from pyriskmgmt.SupportFunctions import garch_warnings
                garch_warnings("mcModelDrawPortRets()")
    ...
    def MargVars(self, sharpeDiag: bool = False , mappingRets: np.ndarray = None, vol: str = "simple", num_sims: int = 10000,
                  p: int = 1, q: int = 1, lambda_ewma: float = 0.94, warning: bool = True):
    ...
    def RelCompVars(self, sharpeDiag: bool = False , mappingRets: np.ndarray = None,  vol: str = "simple", num_sims: int = 10000,
        ...
        MARGINAL_VARS_PROCESS = self.MargVars(sharpeDiag = sharpeDiag, mappingRets =  mappingRets,  vol = vol, num_sims = num_sims,
                                              p = p, q = q, lambda_ewma = lambda_ewma, warning = warning)
    ...
    def VarEsMinimizer(self, sharpeDiag: bool = False, mappingRets: np.ndarray = None, vol: str = "simple",
                        p: int = 1, q: int = 1, lambda_ewma: float = 0.94, allow_short: bool = True, warning: bool = True):
